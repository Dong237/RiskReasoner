...
def main():
    ...
    input_filename = "datasets/generator/test_balanced_posterior_generator_cot_N_llama_r1.json"
    # Specify the output JSON file to store the selected responses
    output_filename = "datasets/verified/test_balanced_posterior_generator_cot_N_llama_r1_voted_response.json"
